...
class SimianViewerPluginConan(ConanFile):
    """Class to package SimianViewerPlugin plugin using conan
    ...
    topics = ("hdps", "ManiVault", "plugin", "SimianViewerPlugin", "data visualization")
    url = "https://github.com/ManiVaultStudio/SimianViewerPlugin"
