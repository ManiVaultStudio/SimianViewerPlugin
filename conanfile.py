...
class SimianViewerPluginConan(ConanFile):
    """Class to package SimianViewerPlugin using conan
    ...
    name = "SimianViewerPlugin"
    description = (
        "A plugin for viewing simian data in the high-dimensional plugin system (HDPS)."
    )
    topics = ("hdps", "plugin", "simian data", "viewing")
    url = "https://github.com/hdps/SimianViewerPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/SimianViewerPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/SimianViewerPlugin")
        cmake.verbose = True
        return cmake
    ...
    def build(self):
        ...
        # The SimianViewerPlugin build expects the HDPS package to be in this install dir
