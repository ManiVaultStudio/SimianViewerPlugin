        ...
        // create a tooltip
         tip = d3.tipFull()
            ...
            .html(function (d,mouse) {
                ...
                formatTooltipContents = formatTooltipContents + "<tr><td   style=\" font-size: 5;\"><b>Subclass<b/></td><td  style=\"  -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + subClassColors[d.subclass_1] + "; \"> " + d.subclass_1 + "</td><td   style=\"  -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + subClassColors[d.subclass_2] + "; \">" + d.subclass_2 + "</td></tr><tr><td   style=\"\"><b>Class<b/></td><td   style=\"  -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + classColors[d.class_1] + ";\">" + d.class_1 + "</td><td   style=\" -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + classColors[d.class_2] + ";\">" + d.class_2 + "</td></tr>"
                if (d.cross_species_cluster1_species_1 == d.cross_species_cluster2_species_2) {
                    formatTooltipContents = formatTooltipContents + "<tr ><td style=\"font-size: 5; \"><b>Cross-species <b/></td><td colspan=\"2\" style=\"   -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + cross_speciesClustercolors[d.cross_species_cluster1_species_1] + ";\">" + d.cross_species_cluster1_species_1 + "</td></tr>"
                }
                else {
                    formatTooltipContents = formatTooltipContents + "<tr ><td style=\"font-size: 5; \"><b>Cross-species <b/></td><td  style=\" -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + cross_speciesClustercolors[d.cross_species_cluster1_species_1] + ";\">" + d.cross_species_cluster1_species_1 + "</td><td   style=\"   -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: " + cross_speciesClustercolors[d.cross_species_cluster2_species_2] + ";\">" + d.cross_species_cluster2_species_2 + "</td></tr>"
                }
                formatTooltipContents = formatTooltipContents + "<tr><td   style=\"font-size: 5;\"><b>Distance<b/></td><td colspan=\"2\"    style=\"  -webkit-text-fill-color: black; -webkit-text-stroke-width: 0.5px; -webkit-text-stroke-color: #D3D3D3;\">" + clustDistVal + "</td></tr>";
                if (layercheck.includes(species1ValueIdentify) || layercheck.includes(species2ValueIdentify)) {
                    formatTooltipContents = formatTooltipContents + "<tr><td  style=\"font-size: 5; \"><b>Layer distribution<b/></td><td colspan=\"2\"  style=\" \"><div style=\"width:100%\"><div id=\"tipDiv\"></div></div></td></tr>";
                }
