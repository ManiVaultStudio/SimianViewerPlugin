...
/**
 * @constructor
//<Class definition for the SimianViewerDataQueue>
...
(function (global) {
function SimianViewerDataQueue(queueLimit, processingCallback) {
...
SimianViewerDataQueue.prototype = {

    constructor: SimianViewerDataQueue,
    ...
    /**
     * @param data - the simian_viewer data 
     */
...
if (typeof module === 'object' && module.exports) module.exports = SimianViewerDataQueue;
else global.SimianViewerDataQueue = SimianViewerDataQueue;
